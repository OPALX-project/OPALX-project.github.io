...
To enable GPU usage in OPAL-DKS option ENABLEDKS must be set in the OPAL input file:

`OPTION, ENABLEDKS=TRUE`
...
`CXX=<c++ compiler> CC=<c compiler> -DCMAKE_INSTALL_PREFIX=<DKS install dir> <path to DKS source>`
