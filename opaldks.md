...
To install OPAL-1.6 with DKS, version 1.1.X is required. Installation instructions for this version can be found here [DKS 1.1.X](https://gitlab.psi.ch/uldis_l/DKS/wikis/dks-1.1.2)

To install OPAL-2.0 with DKS, version 1.1.X is required. Installation instructions for this version can be found here [DKS 1.1.X](https://gitlab.psi.ch/uldis_l/DKS/wikis/dks-1.1.2)
