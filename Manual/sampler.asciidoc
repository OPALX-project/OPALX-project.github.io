...
| SEQUENCE      | Boolean to choose how the sample spaces for the DVARS are combined, see below, (default: true)
...
The difference between `SEQUENCE = TRUE` and `SEQUENCE = FALSE` is depicted in the following figure.
image:figures/differenceSEQUENCESampler_scale.svg[scaledwidth=10cm]
