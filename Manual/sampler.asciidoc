...
Sampler
--------
This is a special feature of the [optimiser](https://gitlab.psi.ch/OPAL/src/wikis/Manual/optimiser). Instead of performing a multi-objective optimisation, it creates samples
