...
| GAUSSIAN_SEQUENCE | Generates a sequence with a gaussian distribution taking
                      the difference between upper and lower bound of the design
                      variable as 10 sigmas.
| GAUSSIAN_RANDOM   | Gaussian random sampling of floats. The upper and lower bound
