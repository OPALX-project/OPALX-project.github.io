...
[[chp:sample]]
Sampler **(be aware of the fact, this is an experimental feature)**
--------
...
SEQUENCESAMPLE Command (Sequence Mode)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
[#samplecommandattributes]
.Attributes for the command SEQUENCESAMPLE.
...
SAMPLE Command (Random Mode)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^
The SAMPLE command has the following attributes in addition to the attributes of the SEQUENCESAMPLE command
[#samplecommandattributes]
.Attributes for the command SEQUENCESAMPLE.
[cols="<1,<5",options="header",]
|=======================================================================
...
| N         | Number of samples per this design variable (only in sequence mode)
|=======================================================================
