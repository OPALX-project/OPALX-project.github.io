...
Here some facts on “ What is the tradeoff between population size and the number of generations in genetic algorithms:

https://cstheory.stackexchange.com/questions/5156/what-is-the-tradeoff-between-population-size-and-the-number-of-generations-in-ge
...
| statVariableAt(<var>, <spos>)              | The same as `sddsVariableAt`, uses OPALs statistics file.
