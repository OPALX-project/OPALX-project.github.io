...
[#OPALTSchemeSimple]
.Figure 2 : Schematic workflow of _OPAL-t_’s execute method.
image:figures/opalt/flowdiagram.png[]

A regular time step in _OPAL-t_ is sketched in
Figure <<OPALTSchemeSimple,2>>. In order to compute the coordinate system
...
As can be seen from Figure <<OPALTSchemeSimple,2>> the integration of the
