...
an integrated Green [qiang2005, qiang2006-1,qiang2006-2] function to
...
cathode [fubiani2006, qiang2005, qiang2006-1,qiang2006-2]. For
...
Section [Element:common]. The old notation using `ELEMEDGE` is still
...
freely in three-dimensional space. See Section [Element:common] for how
...
can then be opened in e.g. ParaView [paraview,bib:paraview] or VisIt
...
see Chapter [beam], however due to the underlying general structure, the
