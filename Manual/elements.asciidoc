...
K1S::
  ...
  latexmath:[0 \mathrm{Tm^{-1}}]. The component is negative, if
...
K3::
  ...
  is latexmath:[0 \mathrm{Tm^{-3}}]. The component is positive, if
  latexmath:[B_y] is positive on the positive latexmath:[x]-axis.
K3S::
  The skew octupole component
  latexmath:[K_{3s}=-\frac{\partial{^3}B_x}{\partial x^{3}}]. The
  default is latexmath:[0 \mathrm{Tm^{-3}}]. The component is negative, if
  latexmath:[B_x] is positive on the positive latexmath:[x]-axis.
...
KN::
  ...
  (default is latexmath:[0 \mathrm{Tm^{-n}}]). A component is positive, if
  latexmath:[B_y] is positive on the positive latexmath:[x]-axis.
KS::
  ...
  (default is latexmath:[0 \mathrm{Tm^{-n}}]). A component is negative, if
  latexmath:[B_x] is positive on the positive latexmath:[x]-axis.
...
KS::
  ...
  latexmath:[0 \mathrm{Tm^{-1}}]. For positive `KS` and positive particle
