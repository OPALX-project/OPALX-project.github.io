...
Table <<distattremitmodelnoneastra,16>>. The `NONE` emission model is very
...
option as listed in Table <<distattremitmodelnoneastra,16>>. However, in this
...
Table <<distattremitmodelnonequil,17>>.
