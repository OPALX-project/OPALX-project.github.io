...
image:./figures/distribution/flattop.png[width=700]
...
Table <<binomdist,15>> and shown in Figure_<<binomialproperties,2>>.
...
[#binomialproperties]
.Figure 2: Properties of binomial Phase Space Distributions (taken from  <<bib:JohoDist>>).
image:./figures/distribution/BinomialProperties.png[width=700]
...
|`MZ` |10001 | |Defines parameter latexmath:[m] for the binomial distribution in latexmath:[z]
|`MT` |10001 | |Defines parameter latexmath:[m] for the binomial distribution in latexmath:[t]
|=======================================================================
