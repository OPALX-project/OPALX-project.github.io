HEADER 'Linear Compton 90 degree weak-field finite-beam energy-spread benchmark';
!!
...
SET ee=1.0D9, an=9.0D5,
    sigz=0.0,
    betax=1000.0*mm, betay=1000.0*mm,
    emitx=1.0D-6, emity=1.0D-6,
    sige=1.0D-3,
    ntcut=3.0;

SET laserwl=1030*nm,
    rlx=1.25D+01, rly=1.25D+01,
    sigt=1.0*psec,
    pulseE=7.25D+03;
...
DRIFT S=0.05;
WRITE BEAM, KIND=photon, FILE='cain-linear-compton-90deg-xi029-finite-beam-energy-spread.dat';
