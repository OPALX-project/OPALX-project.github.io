...
- unit tests verify the Thomson limit, exact recoil endpoints, spectrum
  normalization, the exact 90 degree forward-scattering benchmark, a
  deterministic weak-field CAIN spectrum comparison, and a fixed-seed
  host-only Monte Carlo spectrum comparison
