...
- `~/git/OPALX-project.github.io/gamma-gamma/generate-linear-compton-results.sh`
...
- [*] finite-beam energy and angle spectra,
- [*] finite-beam plus energy-spread energy and angle spectra.
...
.Finite-beam linear-Compton photon energy spectrum for the benchmark beam with pass:[&sigma;<sub>x</sub>] = pass:[&sigma;<sub>y</sub>] = 1 mm and pass:[&sigma;<sub>x'</sub>] = pass:[&sigma;<sub>y'</sub>] = 1 mrad. The figure compares CAIN and the OPALX deterministic benchmark.
image::reference-data/linear-compton-90deg-xi029-finite-beam-comparison.png[width=82%]

.Finite-beam linear-Compton photon laboratory polar-angle spectrum for the same benchmark beam. The figure compares CAIN and the OPALX deterministic benchmark on the common angular histogram grid.
image::reference-data/linear-compton-90deg-xi029-finite-beam-theta-comparison.png[width=82%]

.Finite-beam linear-Compton photon energy spectrum with additional electron-beam relative energy spread pass:[&sigma;<sub>E</sub>/E] = 1e-3. The figure compares CAIN and the OPALX deterministic benchmark.
image::reference-data/linear-compton-90deg-xi029-finite-beam-energy-spread-comparison.png[width=82%]

.Finite-beam linear-Compton photon laboratory polar-angle spectrum with additional electron-beam relative energy spread pass:[&sigma;<sub>E</sub>/E] = 1e-3. The figure compares CAIN and the OPALX deterministic benchmark.
...
The one-shot benchmark workflow for this note is run from the docs tree:
...
- runs the CAIN decks `~/git/cain/cain-linear-compton-90deg.i`, `~/git/cain/cain-linear-compton-90deg-finite-beam.i`, and `~/git/cain/cain-linear-compton-90deg-finite-beam-energy-spread.i`,
...
- the three CAIN decks in `~/git/cain`, unless overridden by `--cain-deck-dir`.
