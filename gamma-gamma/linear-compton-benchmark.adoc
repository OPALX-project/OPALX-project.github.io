...
- connect the validated host-only Compton sampler to photon-bunch population
...
.Generated weak-field CAIN vs OPALX deterministic and sampled spectrum overlay
image::reference-data/linear-compton-90deg-xi029-comparison.png[width=85%]

=== Lab-Angular Benchmark
...
To keep the angular comparison tied to the Compton kernel rather than to beam
optics, the stored CAIN weak-field reference uses zero emittance and zero bunch
length on the electron side.
