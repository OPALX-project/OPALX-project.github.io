...
These recipes can be used with Linux and macOS. Tested with:
...
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-gmp[GMP]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-mpfr[MPFR]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-mpc[MPC]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-gcc[GCC]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-cmake[CMake]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-open-mpi[open-mpi]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-hdf5[HDF5]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-gsl[GSL]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-h5hut[H5hut]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-boost[Boost]
1. optional: link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-parmetis[ParMETIS]
1. optional: link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-openblas[OpenBLAS] +
Please note: the (experimental?) CMake script had some issues. +
You may try with other targets than `CORE2`. For auto-detection just run `make`.
1. optional: link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-trilinos[Trilinos]
...
1. optional: link:Recipes/trilinos[Trilinos]
...
1. link:Recipes/h5hut[H5hut]
1. link:Recipes/boost[Boost]
1. optional: link:Recipes/parmetis[ParMETIS]
1. optional: link:Recipes/openblas[OpenBLAS]
1. optional: link:Recipes/trilinos[Trilinos]
