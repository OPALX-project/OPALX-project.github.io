...
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-parmetis[ParMETIS]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-openblas[OpenBLAS]
1. link:https://gitlab.psi.ch/OPAL/build-recipes/raw/master/build-trilinos[Trilinos]
'''
