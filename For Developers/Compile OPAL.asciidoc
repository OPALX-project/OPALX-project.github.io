...
| cmake |3.0.0 | 3.11.4| Please note that version 3.6.3 has some known issues
  with hdf5. 
...
Before compiling everything yourself, you might want to try the versions available on your system. Check the requirements before trying. The following software usually works without problems: cmake >= 3.0.0, gcc >= 5.3.0, gsl >= 2.4, boost >= 1.59.
