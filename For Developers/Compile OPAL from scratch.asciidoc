...
| GNU Compiler Collection | 5.3.0 | 7.3.0 | Use GCC >= 7.1.0 on macOS!
...
| boost | 1.59 | 1.68.0 
| The following boost libraries are required: `chrono`,  filesystem iostreams regex serialization system
