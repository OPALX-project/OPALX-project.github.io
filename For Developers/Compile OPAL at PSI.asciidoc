...
modmanage install boost/1.62.0 --with=gcc/5.4.0
modmanage install gsl/2.2.1 --with=gcc/5.4.0
modmanage install gtest/1.7.0 --with=gcc/5.4.0
modmanage install OpenBLAS/0.2.19 --with=gcc/5.4.0
modmanage install root/6.08.02 --with=gcc/5.4.0
modmanage install parmetis/4.0.3 --with=gcc/5.4.0 --with=openmpi/1.10.4
modmanage install trilinos/12.10.1-1 --with=gcc/5.4.0 --with=openmpi/1.10.4 --with=hdf5/1.8.18
modmanage install H5hut/2.0.0rc3 --with=gcc/5.4.0 --with=openmpi/1.10.4 --with=hdf5/1.8.18
```
...
If you do not want/can use the meta-module, you have to load the modules one by one:
```
...
module load trilinos/12.10.1-1
```
Optional:
```
