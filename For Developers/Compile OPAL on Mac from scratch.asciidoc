...
* cmake >= 3.9 (there are some known issues with older versions, especially 3.6.3)
* Open MPI >= 1.10.2 (1.10.4 for OPAL 1.6, 1.10.7 for OPAL 2.0)
* hdf5 >= 1.8.18 (1.8.18 for OPAL 1.6, 1.10.1 for OPAL 2.0) 
* GNU Scientific Library >= 2.4 (2.4)
* H5hut >= 2.0.0rc3 (2.0.0rc4)
* boost >= 1.59 (1.62.0 for OPAL 1.6, 1.66.0 for OPAL 2.0)
...
`PREFIX`::
is the common installation prefix for all software we have to compile and install. In the following instructions we use `${HOME}/OPAL`.
