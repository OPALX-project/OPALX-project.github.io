...
'''
=== Building Boost
The installation of OPAL fails with the currently provided Boost module (```Boost/1.62.0-CrayGNU-2016.11-Python-3.5.2```). Thus, we install it locally. Perform the following steps:
...
> export GSL_HOME= /apps/daint/UES/jenkins/6.0.UP02/mc/easybuild/software/GSL/2.1-CrayGNU-2016.11/
> export GSL_DIR=$GSL_HOME
> export GSL_PREFIX=$GSL_PREFIX
> export GSL_INCLUDE_DIR=$GSL_HOME/include
> export GSL_LIBRARY_DIR=$GSL_HOME/lib
...
load_opal_gcc530() {
    ...
    export GSL_HOME=
    /apps/daint/UES/jenkins/6.0.UP02/mc/easybuild/software/GSL/2.1-CrayGNU-2016.11/
    export GSL_DIR=$GSL_HOME
    export GSL_PREFIX=$GSL_PREFIX
    export GSL_INCLUDE_DIR=$GSL_HOME/include
    export GSL_LIBRARY_DIR=$GSL_HOME/lib
