...
well as with the Windows Services for Linux. Before compiling the required
software, check the minimum installation requirements
link:https://github.com/OPALX-project/OPALX-project.github.io/blob/master/For-Developers/Supported-OS-and-required-Software-to-build-OPAL.adoc[here].
...
[listing]
--
git clone https://github.com/OPALX-project/build-recipes.git
--
...
**Specific requirements for some OPAL features**
----
./200-build-parmetis
./210-build-openblas
./220-build-trilinos
