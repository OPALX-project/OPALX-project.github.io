...
Compiling _OPAL_ can be quite challenging due to all link:https://github.com/OPALX-project/OPALX-project.github.io/blob/master/For-Developers/Compile-required-software.adoc[the required libraries]. Even if some libraries are available on the system, this
...
.Trilinos
====
For compiling Trilinos please see the https://github.com/OPALX-project/build-recipes/blob/master/220-build-trilinos[Trilinos build recipe].
====
