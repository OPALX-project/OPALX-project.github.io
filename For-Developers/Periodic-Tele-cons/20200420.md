...
Andreas Adelmann, Pedro Calvo, Dragos Constantin, Matthias Frey, Simon Friederich, Martina Grether, Achim Gsell, Chris Hall, Anastasia Ierides, Christof Kraus, Bettina Kuske, Christopher Mayes, Nicole Neveu, Philippe Piot, Chris Rogers, Ryan Roussel, Jochem Snuverink, Murali Sriramkrishnan, Yine Sun, Sebastian Thomas, Stephen Webb, Daniel Winklehner.
...
* [ ] Bettina can share BerlinPRO example
* [ ] Chris Mayes and Nicole can share their examples
...
#### Discussion on integration of features - Achim
...
* Murali: I have read that one can mirror automatically the fork repository, how can you automatically merge
...
#### Python integration for OPAL - Chris Rogers

code: https://gitlab.psi.ch/ext-rogers_c/src/tree/master/src/PyOpal

interactive example with field lookup
...
#### pyOPALTools - Matthias

Nicole: would we keep those two tools separate? or would Chris use this library in some way?
Chris: it feels like this is more focused on post-processing, and what I was doing is more focused on the pre-processing.
Andreas: I propose to discuss this at the end.

#### Sirepo - Stephen Webb and Chris Hall
...
Demonstration (environment is actually the same for Zgoubi, Elegant, OPAL, Synergia).
* beamline editor
* calculate twiss
...
* Lattice tab:
    ...
    * you can define variables and add them to elements.
        * see how things change with a single variable
* Source tab
...
* brand new up since a month

Coming up:
* MadX input for all of the codes

* Andreas: tried it last week. If I have a class of students of 10-20 students, how will I do it? 20 jobs simultaneous at the same time is that possible?
...
* Stephen: Sirepo is for beginner, jupyter is for intermediate-advance
...
* [ ] Chris Rogers will set up a next meeting for to discuss the document.
