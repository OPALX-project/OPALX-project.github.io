...
1. [Minutes](#minutes)
    1. [1. News and Introduction - Andreas](#1-news-and-introduction-andreas)
    1. [2. Discussion on integration of features - Achim](#2-discussion-on-integration-of-features-achim)
    1. [3. Python integration for OPAL - Chris Rogers](#3-python-integration-for-opal-chris-rogers)
    1. [4. pyOPALTools - Matthias](#4-pyopaltools-matthias)
    1. [5. Sirepo - Stephen Webb and Chris Hall](#5-sirepo-stephen-webb-and-chris-hall)
    1. [6.Open discussion and/or buffer](#6-open-discussion-andor-buffer)
1. [To Dos](#to-dos)
...
* [ ] Nicole: open issue for boost CMake change
* [ ] Chris Rogers: write document with specifications
