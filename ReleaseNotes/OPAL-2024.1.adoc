= Release Notes for https://gitlab.psi.ch/OPAL/src/-/milestones/33[OPAL 2024.1]
:pp: {plus}{plus}

// == https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Bug&milestone_title=2024.1[Bugfixes in OPAL 2024.1]
== Bugfixes in OPAL 2024.1
...
* Fix monitor memory usage (#792)

// == https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Feature%20request&milestone_title=2024.1[New features in OPAL 2024.1]
== New features in OPAL 2024.1
...
* Elliptical shape for `DEGRADER` (#786)
* New element `OUTPUTPLANE` (#793)

//== https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Enhancement&milestone_title=2024.1[Enhancements in OPAL 2024.1]
== Enhancements in OPAL 2024.1
...
* `MAX_R` and `MIN_R` attributes of `RINGDEFINITION` (#790)

//== https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Cleanup&milestone_title=2024.1[Code improvements]
== Code improvements
...
* Unify internal units in elements (#762, #773, #787)
* Use scoped enumerations to overcome string comparison (#772, #776, #783)
* PyOPAL cmake option (#788, #807)
* Use C{pp} standard functions instead of Boost (#797, #798, #799)
...
== https://gitlab.psi.ch/OPAL/src/-/wikis/home#user-content-start-with-examples[New OPAL Examples to get started]

* AWA https://gitlab.psi.ch/OPAL/src/-/wikis/Examples/AWAEEXBeamline[EXX Beamline] : TCAV
* AWA https://gitlab.psi.ch/OPAL/src/-/wikis/Examples/AWADriveLinac[Drive Linac] : Traveling Wave Structure
