= Release Notes for https://gitlab.psi.ch/OPAL/src/-/milestones/27[OPAL 2.4]

== https://gitlab.psi.ch/OPAL/src/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Bug&milestone_title=OPAL%202.4.0[Bugfixes in OPAL 2.4.0]
...
* https://gitlab.psi.ch/OPAL/src/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Cleanup&milestone_title=OPAL%202.4.0[Large code cleanup]
// - * Fix for Autophasing (#568): This was only due to #515

== https://gitlab.psi.ch/OPAL/src/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Feature%20request&milestone_title=OPAL%202.4.0[New features in OPAL 2.4.0]
