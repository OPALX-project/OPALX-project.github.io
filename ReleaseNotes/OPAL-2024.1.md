# Release Notes for [OPAL 2024.1](https://gitlab.psi.ch/OPAL/src/-/milestones/33)

## [Bugfixes in OPAL 2024.1](https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Bug&milestone_title=2024.1)
...
## [New features in OPAL 2024.1](https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Feature%20request&milestone_title=2024.1)
...
## [Enhancements in OPAL 2024.1](https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Enhancement&milestone_title=2024.1)
...
## [Code improvements](https://gitlab.psi.ch/OPAL/src/-/issues?scope=all&utf8=%E2%9C%93&state=all&label_name[]=Cleanup&milestone_title=2024.1)
...
* Use C++ standard functions instead of Boost (#797, #798, #799)
...
## [New OPAL Examples to get started](https://gitlab.psi.ch/OPAL/src/-/wikis/home#user-content-start-with-examples)
* AWA [EXX Beamline](https://gitlab.psi.ch/OPAL/src/-/wikis/Examples/AWAEEXBeamline) : TCAV
* AWA [Drive Linac](https://gitlab.psi.ch/OPAL/src/-/wikis/Examples/AWADriveLinac) : Traveling Wave Structure