...
* New `BEAM` attribute (`MOMENTUM_TOLERANCE`, default=1e-2) setting a fractional tolerance to deviations in the distribution compared to the reference data at initialization
