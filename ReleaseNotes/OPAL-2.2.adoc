...
== https://gitlab.psi.ch/OPAL/src/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Bug&label_name[]=OPAL%202.2[Bugfixes in OPAL 2.2.1]

* Fix for segmentation fault in FromFile due to RASTER=TRUE (#465)
* Fix format of _ElementPositions.sdds files (#468)

== https://gitlab.psi.ch/OPAL/src/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Bug&label_name[]=OPAL%202.1[Bugfixes in OPAL 2.2.0]
...
== https://gitlab.psi.ch/OPAL/src/issues?scope=all&utf8=%E2%9C%93&state=closed&label_name[]=Feature%20request&label_name[]=OPAL%202.1[New features in OPAL 2.2.0]
...
* Many more features, for details see the http://amas.web.psi.ch/opal/Documentation/2.2/OPAL_Manual.html[manual]
