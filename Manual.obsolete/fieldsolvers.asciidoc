...
See Table <<fieldsolvercmd,1>> for a summary of the Fieldsolver command.
...
integrated Green’s function is described in <<bib:qiang2005>>, <<bib:qiang2006-1>>,
<<bib:qiang2006-2>>. Default setting is `INTEGRATED`.
