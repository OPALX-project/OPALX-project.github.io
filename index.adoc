...
https://github.com/OPALX-project/OPAL/releases/download/OPAL-2024.1.0/OPAL-2024.1.0.tar.xz

## [red] *Download, Documentation, Help, Presentations & Papers*
...
| n.a.
| n.a.
| {link_manual}/master[HTML], {link_manual}
| {link_doxydoc}/master[HTML]
| link:ReleaseNotes/OPAL-2023.1[Wiki]

| {link_src}/OPAL-2024.1.0/OPAL-2024.1.0.tar.xz[_OPAL_ 2024.1.0] ({link_src}/OPAL-2024.1.0/OPAL-2024.1.0.tar.xz.md5[md5])
| 
| 
| {link_manual}/2024.1[HTML]
