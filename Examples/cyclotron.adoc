...
If you do not have already access to OPAL, you can visit the download page link:home[the download page]. In
...
| link:uploads/7697ea84f47c30e9c80c63f58b8505eb/cyclotron1.in[cyclotron1.in] and link:uploads/7d4ce0fdf2f5cfaed4921c58d26e7026/cyclotron2.in[cyclotron2.in] (link:Cyclotron/1.6/cyclotron1.in[cyclotron1.in] and link:Cyclotron/1.6/cyclotron2.in[cyclotron2.in] for 1.6.x)
| the OPAL input files

| link:Cyclotron/bfield.dat[bfield.dat]
| magnetic field map

| link:Cyclotron/rffield1.dat[rffield1.dat] and link:Cyclotron/rffield2.dat[rffield2.dat]
| rf field maps

| link:Cyclotron/dist1.dat[dist1.dat] link:Cyclotron/dist2.dat[dist2.dat]
| the input distributions

| link:Cyclotron/ic.dat[ic.dat]
| initial conditions for the tune calculation

| link:Cyclotron/refsol.dat[refsol.dat]
| the reference solution for the tune calculation

| link:Cyclotron/cyclotron1.gpl[cyclotron1.gpl] and link:Cyclotron/cyclotron2.gpl[cyclotron2.gpl] (link:Cyclotron/1.6/cyclotron2.gpl[cyclotron2.gpl] for 1.6.x)
| plotting scripts for gnuplot
|===
...
The Bash script link:Cyclotron/cyclotron1.bash[cyclotron1.bash] will run the tune calculation for all energies specified in ic.dat and store the
...
A comparison can be plotted with http://www.gnuplotting.org[gnuplot], by executing

`gnuplot cyclotron1.gpl`

The result is saved in cyclotron1.pdf and shown below.

image::Cyclotron/cyclotron1.png[tunesFIXPO]
...
| File | Description |
| --- |-----|
| link:uploads/a45407d49ba5b59f9fb1c43d55664b5c/cyclotronTune-2-1.in[cyclotronTune-2-1.in] | OPAL input file |
| link:Cyclotron/bfield.dat[bfield.dat] | magnetic field map |
| link:Cyclotron/plotTunes.py[plotTunes.py] | python (version 3) plotting script for tune calculation |
...
More information on the matched gauss distribution can be found in the http://amas.web.psi.ch/opal/Documentation/2.2/OPAL_Manual.html#sec.distribution.gaussmatchedtype[Manual].
...
image::Cyclotron/RingTunes.png[TunesClosedOrbitFinder]
...
image::Cyclotron/cyclotron2.png[Orbit]
